...
> **사내 전용 자료**
>
> 이 프로젝트는 사내 업무 목적으로 제작되었습니다. 회사가 자체 제작한 소스 코드, 문서, 디자인 및 기타 결과물은 회사의 사전 서면 승인 없이 복제, 수정, 외부 공개, 배포하거나 상업적으로 이용할 수 없습니다. 오픈소스 소프트웨어와 공공데이터에는 각 제공자가 정한 별도의 이용 조건이 적용됩니다.
...
이 저장소에서 회사가 자체 제작한 소스 코드, 문서, 디자인 및 기타 결과물은 사내 사용을 전제로 하며, 별도의 허가가 없는 한 외부 공유 및 재배포를 금지합니다.
