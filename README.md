...
> **이용 안내**
>
> 이 서비스는 공공데이터 활용 사례로 제작되었으며 누구나 웹에서 이용할 수 있습니다. 단, 회사가 자체 제작한 소스 코드, 문서, 디자인 및 기타 결과물은 회사의 사전 서면 승인 없이 복제, 수정, 외부 공개, 배포하거나 상업적으로 이용할 수 없습니다. 오픈소스 소프트웨어와 공공데이터에는 각 제공자가 정한 별도의 이용 조건이 적용됩니다.
...
웹에 공개된 서비스는 누구나 이용할 수 있습니다. 다만 이 저장소에서 회사가 자체 제작한 소스 코드, 문서, 디자인 및 기타 결과물은 별도의 허가가 없는 한 외부 공유 및 재배포를 금지합니다.

다음 자료에는 해당 제공자가 정한 라이선스 또는 이용 조건이 우선 적용됩니다.

- 프로젝트에서 사용하는 오픈소스 라이브러리 및 관련 소프트웨어
- 한국보훈복지의료공단 등 외부 기관이 제공한 공공데이터
